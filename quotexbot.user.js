  ...
  function render() {
    ...
    root.innerHTML = `
      ...
      <div class="body">
        ...
        <div class="btns">
          <button class="up" type="button" data-act="up" ${(demo || state.liveAck) && !tradeBusy() ? "" : "disabled"}>উপরে</button>
          <button class="down" type="button" data-act="down" ${(demo || state.liveAck) && !tradeBusy() ? "" : "disabled"}>নিচে</button>
        </div>
